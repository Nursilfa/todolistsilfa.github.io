...
$koneksi = mysqli_connect('localhost', 'root', '', 'silfa_ukk2025');
if (!$koneksi) {
...
<head>
    ...
    <title>Nursilfa Ismiatulhawa</title>
    ...
    <div class="container mt-2">
        ...
        <form method="POST" class="border rounded bg-light p-2">
            ...
            <select name="priority" class="form-control" required>
                ...
                <option value="3">Penting Banget</option>
            </select>
        ...
        <form method="POST" class="border rounded bg-light p-2">
            ...
            <select name="priority" class="form-control" required>
                ...
                <option value="3" <?php if($edit_data['priority'] == 3) echo "selected"; ?>>Penting Banget</option>
            </select>
            <label class="form-label">Tanggal</label>
